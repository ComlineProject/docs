...
### [Interface Definition Language (IDL or also named Schema)](./knowledge/idl/index.md)
Some of the distinct differences to other libraries is that this
[IDL/Schema](./knowledge/idl/index.md) allows to be more flexible, optional or robust, 
...
### [Intermediate Representation (IR)](./knowledge/ir/index.md)
...
### [Code Generation (Codegen)](./knowledge/codegen/index.md)
